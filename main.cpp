...
const unsigned int Fcount = 10000000; // æ–‡ä»¶é‡Œæ•°æ®çš„è¡Œæ•°
const unsigned int number_to_sort = 1000000; //åœ¨å†…å­˜ä¸­ä¸€æ¬¡æ’åºçš„æ•°é‡
const char *unsort_file = "unsort_data.txt"; //åŸå§‹æœªæ’åºçš„æ–‡ä»¶å
const char *sort_file = "sort_data.txt"; //å·²æ’åºçš„æ–‡ä»¶å
void init_data(unsigned int num); //éšæœºç”Ÿæˆæ•°æ®æ–‡ä»¶
