//
// Created by simon on 2022/11/16.
//

#ifndef BUAA_PROGRAMMINGANDALGORITHMS_TERMPROJECT_EXTERNSORT_H
#define BUAA_PROGRAMMINGANDALGORITHMS_TERMPROJECT_EXTERNSORT_H
...
const unsigned int number_to_sort = 10000000; //在内存中一次排序的数量
char *unsort_file = "unsort_data.txt"; //原始未排序的文件名
char *sort_file = "sort_data.txt"; //已排序的文件名
...
protected:
    ...
    void Adjust(int s) {//沿从叶子节点b[s]到根节点ls[0]的路径调整败者树
    ...
    void K_Merge() {//利用败者数把k个输入归并段归并到输出段中
...
#endif //BUAA_PROGRAMMINGANDALGORITHMS_TERMPROJECT_EXTERNSORT_H
